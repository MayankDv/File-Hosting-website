	...
	<div class="container">
		<div class="header d-lg-flex justify-content-between align-items-center">
			<div class="header-inner">
				<h1>
					<a class="navbar-brand logo" href="mainpage.php">
...
<div class="contact py-sm-5 py-4" id="contact">
	<div class="container py-lg-3">
		<h3 class="heading mb-4"> Give Requirement </h3>
		<div class="row pt-lg-4">
			<div class="col-lg-5">
				<div class="main-contact-left">
					<h4 class="contact-left mb-4"> Requirements</h4>
					
						<hr>
					<p><span class="fa fa-phone mr-2"></span>  +012 898 909 2317</p>
						<hr>
			...
			<div class="col-lg-7 mt-lg-0 mt-5">
				...
				<div class="register-top1">
					<form action="saverequirement.php" method="post" class="register-newsletter">
						<div class="form-group">
							<div class="row">
								<div class="col-md-6">
									<input class="form-control" type="text" placeholder="Enter Your Oragnization Name" name="oname">
						...
						<div class="form-group">
							<div class="row">
								<div class="col-md-6">
									<input class="form-control" type="text" placeholder="Enter Your Topic Name Related" name="pname" required="">
								</div>
						...
						<div class="row mt-3">
							<div class="col-md-12">
								<button type="submit" class="btn btn-subscribe btn-block w-100 text-uppercase">Send</button>
							</div>
						</div>
					</form>
				</div>
