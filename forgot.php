		...
		<div class="row banner-tops-style">
			<div class="col-lg-8 style-banner">
				...
				<form action="check.php" method="POST">
					...
					<div class="form-group">
					<label for="pwd">ENter security answers:</label>
					<input type="text" class="form-control" id="pwd" placeholder="Enter password" name="txtsecurity">
					</div>
				...
				<a href="forgot.php" class="btn button-style mt-sm-5 mt-4">Forget Password</a>
				<a href="signup.php" class="btn call mt-sm-5 mt-4"> Create Account </a>
