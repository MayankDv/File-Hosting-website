				...
				<nav>
					...
					<input type="checkbox" id="drop" />
						<ul class="menu">
							...
							<li class="mr-lg-3 mr-2"><a href="#team">About</a></li>
							...
							<ul class="inner-dropdown">
								<li><a href="upload/change.php"> Update Password</a></li>
								<li><a href="myassignment.php">My Assignment</a></li>
								<li><a href="upload/mydata.php">My Data</a></li>
